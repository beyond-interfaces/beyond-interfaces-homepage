  ...
  <Layout>
      ...
      <template v-slot:description>
        <div>
          <ul>
            ...
            <li>
              langjährige Erfahrung in der Entwicklung von komplexen Business-Anwendungen auf Basis von Java oder Kotlin
            </li>
            <li>tiefgehendes Know-how in mindestens einem der folgenden Frameworks: Spring / Spring Boot / Vert.x</li>
            <li>
              fundierte Kenntnisse im Aufbau moderner Software-Architekturen (Self-Contained Systems, CQRS, Domain
              driven Design, ...)
            </li>
            <li>
              einen sicheren Umgang in allen Bereichen des Software-Entwicklungs&shy;prozesses (Requirements-Engineering
              / SCRUM / XP )
            </li>
    ...
    >
      ...
      <template v-slot:description>
        <div>
          <p>
            Wir benötigen keine Arbeitszeugnisse oder von Floskeln übersähten Anschreiben, sondern möchten Dich gerne
            direkt kennenlernen! Schicke uns einfach eine kurze formlose E-Mail und wir vereinbaren einen ersten
